    ...
    <div class="row g-0 h-100">
        ...
        <div class="col-lg-8 position-relative hero-left">
            ...
            <div class="hero-text-content">
                ...
                <!-- View Flyer Button -->
                <div class="mt-4">
                    <a href="{{ Storage::url($schedule->flyer_image) }}" target="_blank" class="btn btn-outline-light rounded-pill px-4">
                        <i class="bi bi-file-image"></i> Lihat Brosur/Flyer
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 hero-right-gold">
            <div class="pricing-content">
                <!-- Removed Quad and Child as requested, logic: Price = Base(Quad?) or Input?
                     User said "Paket hanya Triple dan Double". 
                     Usually Base Price is Quad. If we hide Quad, we need to decide what 'Rp 30jt' means in DB.
                     Assuming: DB has Base Price. We show Triple (Base+2) and Double (Base+4).
                -->
                
                <div class="price-group">
                    <span class="price-label">TRIPLE SHARING</span>
                    <!-- Use explicit price if available, else calc fallback -->
                    <h3 class="price-value">Rp {{ number_format($schedule->price_triple ?? ($schedule->price + 2000000), 0, ',', '.') }}</h3>
                </div>

                <div class="price-group">
                    <span class="price-label">DOUBLE SHARING</span>
                    <h3 class="price-value">Rp {{ number_format($schedule->price_double ?? ($schedule->price + 4000000), 0, ',', '.') }}</h3>
                </div>

                <!-- Optional: Show Child Price if set? User didn't explicitly ask to hide, but "Paket hanya Triple dan Double" implies focus.
                     I will only show Triple/Double as requested.
                -->

                <div class="action-area mt-4 w-100">
                    <!-- Register Button Logic similar to Schedule Page -->
