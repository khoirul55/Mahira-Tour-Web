...
<section class="pb-12 bg-white">
    <div class="container-main max-w-4xl mx-auto px-4 sm:px-6">
        ...
        {{-- Bottom Share --}}
        <div class="mt-8 p-6 rounded-2xl bg-gray-50 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p class="text-sm font-semibold text-primary">Bagikan artikel ini:</p>
            <div class="flex items-center gap-3">
                <a href="https://wa.me/?text={{ urlencode($article->title . ' - ' . url()->current()) }}" 
                   target="_blank" rel="noopener"
                   class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#25D366] text-white text-sm font-semibold no-underline hover:shadow-lg transition-all duration-300">
                    <i class="bi bi-whatsapp"></i> WhatsApp
                </a>
                <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url()->current()) }}" 
                   target="_blank" rel="noopener"
                   class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#1877F2] text-white text-sm font-semibold no-underline hover:shadow-lg transition-all duration-300">
