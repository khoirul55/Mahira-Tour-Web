    ...
    <div class="container-main">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @php
                $contacts = [
                    [
                        ...
                        'external' => true,
                        'iconBg' => 'bg-[#25D366]',
                        'iconShadow' => 'shadow-[0_10px_30px_rgba(37,211,102,0.35)]',
                    ],
                    [
                        ...
                        'external' => false,
                        'stroke' => true,
                        'iconBg' => 'bg-gradient-to-br from-[#001D5F] to-[#002B8F]',
                        'iconShadow' => 'shadow-[0_10px_30px_rgba(0,29,95,0.3)]',
                    ],
                    [
                    ...
                    [
                        ...
                        'action' => 'Lihat Peta',
                        'external' => true,
                        'iconBg' => 'bg-gradient-to-br from-[#EA4335] to-[#C5221F]',
                        'iconShadow' => 'shadow-[0_10px_30px_rgba(234,67,53,0.3)]',
                    ],
                    [
                        ...
                        'iconShadow' => 'shadow-[0_10px_30px_rgba(221,42,123,0.35)]',
                    ],
                    [
            ...
            <div class="rounded-2xl p-6 sm:p-8 lg:p-10 text-center h-full transition-all duration-400 hover:-translate-y-2.5 hover:shadow-xl group bg-white border-2 border-[#E8EBF3] shadow-[0_10px_40px_rgba(0,29,95,0.08)] hover:border-gold">
                <div class="w-14 h-14 sm:w-16 sm:h-16 lg:w-20 lg:h-20 rounded-full flex items-center justify-center mx-auto mb-5 transition-all duration-400 group-hover:scale-110 group-hover:rotate-5 {{ $c['iconBg'] }} {{ $c['iconShadow'] }}">
    ...
    <div class="container-main">
        ...
        <div class="max-w-[900px] mx-auto space-y-5" x-data="{ activeIndex: null }">
            ...
            <div class="rounded-2xl overflow-hidden transition-all duration-300 border-2 border-[#E8EBF3] hover:border-gold"
                ...
                <div class="px-5 sm:px-8 py-4 sm:py-6 text-base sm:text-lg font-bold cursor-pointer flex justify-between items-center gap-3 select-none transition-colors duration-300 hover:text-gold-accessible text-primary"
                     :class="{ '!text-gold-accessible': activeIndex === {{ $i }} }"
