...
<footer style="background: #001D5F; color: white; padding-top: 80px; margin-top: auto;">
    {{-- Footer Top --}}
    <div style="padding-bottom: 60px; border-bottom: 1px solid rgba(255,255,255,0.1);">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-16">
                ...
                <div class="lg:col-span-5">
                    ...
                    <div class="flex items-center gap-3 mb-5">
                        ...
                        <span class="text-xl font-bold font-serif" style="color: white;">Mahira Tour</span>
                    </div>

                    {{-- Badge PPIU --}}
                    <div class="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-semibold mb-5"
                         style="background: rgba(212,175,55,0.15); border: 2px solid rgba(212,175,55,0.3); color: #D4AF37;">
                    ...
                    {{-- Description --}}
                    <p class="text-sm leading-relaxed mb-6 max-w-sm" style="color: rgba(255,255,255,0.75);">
                ...
                <div class="lg:col-span-3">
                    <h5 class="text-base font-bold font-serif mb-6 inline-block pb-2.5" 
                        style="color: white; border-bottom: 2px solid #D4AF37;">Menu</h5>
                    <ul class="list-none m-0 p-0 space-y-3">
                        ...
                        <li>
                            <a href="{{ route($link['route']) }}" 
                               class="text-sm inline-block transition-all duration-300 hover:pl-2"
                ...
                <div class="lg:col-span-4">
                    <h5 class="text-base font-bold font-serif mb-6 inline-block pb-2.5"
                        style="color: white; border-bottom: 2px solid #D4AF37;">Hubungi Kami</h5>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start gap-3 text-sm" style="color: rgba(255,255,255,0.75);">
    ...
    {{-- Footer Bottom --}}
    <div style="padding: 24px 0; background: rgba(0,0,0,0.2);">
        <div class="container-main">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-xs m-0" style="color: rgba(255,255,255,0.65);">
                    &copy; {{ date('Y') }} <strong>Mahira Tour</strong>. All Rights Reserved.
                </p>
                <div class="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-xs"
                     style="background: rgba(212,175,55,0.15); border: 1px solid rgba(212,175,55,0.3); color: #D4AF37;">
