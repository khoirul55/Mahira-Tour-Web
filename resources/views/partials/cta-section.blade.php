    ...
    <div class="container-main">
        <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div class="flex-1 w-full lg:order-1">
                <span class="block text-sm font-bold uppercase tracking-[3px] pl-5 mb-5"
                      style="color: #9A7B2C; border-left: 3px solid #D4AF37; letter-spacing: 3px;">
                    PERJALANAN RUHANI
                </span>
                
                <h2 class="text-3xl lg:text-5xl font-bold uppercase leading-tight mb-7 font-serif"
                    style="color: #001D5F; letter-spacing: 1px;">
                ...
                <div class="flex flex-col sm:flex-row gap-4 sm:gap-5">
                    <a href="https://wa.me/6282184515310?text=Assalamualaikum,%20saya%20ingin%20konsultasi%20paket%20umrah"
                       ...
                       class="inline-flex items-center justify-center gap-2 px-8 py-4 rounded font-bold uppercase 
                       ...
                       onmouseover="this.style.background='#D4AF37'; this.style.color='white'; this.style.boxShadow='0 8px 25px rgba(212,175,55,0.3)';"
                       onmouseout="this.style.background='#001D5F'; this.style.color='white'; this.style.boxShadow='none';">
            ...
            <div class="flex-[1.2] flex gap-5 h-[250px] lg:h-[600px] w-full lg:order-2">
