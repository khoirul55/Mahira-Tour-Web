            ...
            <div class="flex-1 w-full lg:order-1">
                ...
                <div class="flex flex-col sm:flex-row gap-4 sm:gap-5">
                    ...
                    <a href="{{ route('schedule') }}" 
                       class="inline-flex items-center justify-center gap-2 px-8 py-4 rounded font-bold uppercase 
                              tracking-wider text-sm transition-all duration-300 hover:-translate-y-1"
                       style="border: 2px solid #001D5F; color: #001D5F; text-decoration: none; background: transparent;"
                       onmouseover="this.style.background='#001D5F'; this.style.color='white';"
                       onmouseout="this.style.background='transparent'; this.style.color='#001D5F';">
