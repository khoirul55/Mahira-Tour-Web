        ...
        <ul class="hidden lg:flex items-center gap-1 list-none m-0 p-0">
            ...
            <li>
                <a href="{{ route($link['route']) }}" 
                   ...
                   class="nav-link-zen px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200">
                    {{ $link['label'] }}
                </a>
            </li>
            @endforeach
        ...
        <ul class="flex flex-col px-4 py-4 gap-1 list-none m-0 p-0">
            ...
            <li>
                <a href="{{ route($link['route']) }}" @click="mobileOpen = false"
                   class="mobile-nav-link flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all duration-200"
